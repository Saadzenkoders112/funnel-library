      ...
      {state ? (
        <form className='md:w-3/5 w-4/5 h-auto border border-slate-300 rounded-lg shadow-2xl flex flex-col gap-3 p-4'>
          ...
          <p className='font-bold text-xl'>
            Register your funnel library account
          </p>
          ...
          <p className='text-sm text-center'>
            By signup, you are creating a Digital marketing account and agree to
            Digital marketing <span className='text-blue-500'>Terms</span> and{' '}
          ...
          <p className='text-center text-sm cursor-pointer'>
            ...
            <span className='text-blue-500'>
              <button onClick={() => setState(!state)}>google</button>
            </span>
          </p>
        </form>
      ) : (
        <form className='md:w-3/5 w-4/5 h-auto border border-slate-300 rounded-lg shadow-2xl flex flex-col gap-4 p-4'>
          <p className='font-bold text-xl text-center'>
            Log in or sign up to continue browsing apps
          </p>
          <button className='flex items-center gap-2 justify-center p-2 font-semibold rounded-lg border border-slate-300 cursor-pointer'>
            <Image
          ...
          <button
            className='p-2 text-center font-semibold rounded-lg border border-slate-300 cursor-pointer'
          ...
          <p className='text-sm text-blue-500 text-center'>Forgot password?</p>
          <p className='text-sm text-center'>
            By signup, you are creating a Digital marketing account and agree to
            Digital marketing <span className='text-blue-500'>Terms</span> and{' '}
            <span className='text-blue-500'>Privacy Policy</span>
